#!/usr/bin/env python3
"""Create a formal Stage B sampling plan from region candidate summaries."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--summary", default="data_manifests/region_candidates_8k_summary.tsv")
...
def main() -> None:
    args = parse_args()
    split_counts, region_counts = load_counts(Path(args.summary))
    train_windows = args.target_train_tokens // args.context_len
    out = Path(args.out)
            ...
            writer.writerow(
                {
                    ...
                    "target_tokens": target * args.context_len,
    ...
    print(f"wrote {out}")
    print(f"target_train_windows={train_windows} target_train_tokens={args.target_train_tokens}")
